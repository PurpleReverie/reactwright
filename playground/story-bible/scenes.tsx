  ...
  return (
    <section title="PROTOTYPE SCENES" page="script">
      <section title="Scene One — The Inland Tide, Before Dawn" role="scene-heading">
        <p role="stageDirect">INT./EXT. SURVEY SKIFF — THE INLAND TIDE — BEFORE DAWN</p>
        <p role="stageDirect">
      ...
      <section title="Scene Two — Threshold Bridge, Midday" role="scene-heading">
        <p role="stageDirect">EXT. THRESHOLD BRIDGE — VAEL-MIRREN BORDER — MIDDAY</p>
        <p role="stageDirect">
        ...
        <p role="stageDirect">They become aware of each other at exactly the midpoint.</p>
        ...
        <p role="stageDirect">Senna looks at it. Then at him. Then she steps aside and gestures south.</p>
      ...
      <section title="Scene Three — The Pale Warden Speaks" role="scene-heading">
        <p role="stageDirect">INT. THE PALE WARDEN'S TOWER, ORATH'S GATE — NIGHT</p>
        <p role="stageDirect">
        ...
        <p role="stageDirect">They do not sit. He does not seem surprised.</p>
